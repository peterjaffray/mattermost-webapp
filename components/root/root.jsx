...
const LazyLoginController = React.lazy(() =>
    import("components/login/login_controller")
);
...
const LazySignupController = React.lazy(() =>
    import("components/signup/signup_controller")
);
const LazySignupEmail = React.lazy(() =>
    import("components/signup/signup_email")
);
const LazyTermsOfService = React.lazy(() =>
    import("components/terms_of_service")
);
const LazyShouldVerifyEmail = React.lazy(() =>
    import("components/should_verify_email")
);
const LazyDoVerifyEmail = React.lazy(() =>
    import("components/do_verify_email")
);
const LazyClaimController = React.lazy(() => import("components/claim"));
const LazyHelpController = React.lazy(() =>
    import("components/help/help_controller")
);
...
export default class Root extends React.PureComponent {
    ...
    handleLogoutLoginSignal = (e) => {
        ...
        const isNewLocalStorageEvent = (event) =>
